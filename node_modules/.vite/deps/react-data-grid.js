...
var measuringCellClassname = "mlln6zg7-0-0-beta-42";
...
var cell = "cj343x07-0-0-beta-42";
var cellClassname = `rdg-cell ${cell}`;
var cellFrozen = "csofj7r7-0-0-beta-42";
var cellFrozenClassname = `rdg-cell-frozen ${cellFrozen}`;
var cellFrozenLast = "ch2wcw87-0-0-beta-42";
...
var groupCellContent = "g1s9ylgp7-0-0-beta-42";
var groupCellContentClassname = `rdg-group-cell-content ${groupCellContent}`;
var caret = "cz54e4y7-0-0-beta-42";
...
var cellDragHandle = "c1w9bbhr7-0-0-beta-42";
var cellDragHandleFrozenClassname = "c1creorc7-0-0-beta-42";
...
var cellEditing = "cis5rrm7-0-0-beta-42";
function EditCell({
  column,
  colSpan,
  row: row2,
...
var headerSortCellClassname = "h44jtk67-0-0-beta-42";
var headerSortName = "hcgkhxz7-0-0-beta-42";
...
var cellSortableClassname = "c6l2wv17-0-0-beta-42";
var cellResizable = "c1kqdw7y7-0-0-beta-42";
var cellResizableClassname = `rdg-cell-resizable ${cellResizable}`;
var resizeHandleClassname = "r1y6ywlx7-0-0-beta-42";
var cellDraggableClassname = "rdg-cell-draggable";
var cellDragging = "c1bezg5o7-0-0-beta-42";
var cellDraggingClassname = `rdg-cell-dragging ${cellDragging}`;
var cellOver = "c1vc96037-0-0-beta-42";
...
var row = "r1upfr807-0-0-beta-42";
var rowClassname = `rdg-row ${row}`;
var rowSelected = "r190mhd37-0-0-beta-42";
var rowSelectedClassname = "rdg-row-selected";
var rowSelectedWithFrozenCell = "r139qu9m7-0-0-beta-42";
var headerRow = "h10tskcx7-0-0-beta-42";
...
var cellCopied = "c6ra8a37-0-0-beta-42";
var cellCopiedClassname = `rdg-cell-copied ${cellCopied}`;
var cellDraggedOver = "cq910m07-0-0-beta-42";
...
var arrow = "a3ejtar7-0-0-beta-42";
...
var root = "rnvodz57-0-0-beta-42";
var rootClassname = `rdg ${root}`;
var viewportDragging = "vlqv91k7-0-0-beta-42";
var viewportDraggingClassname = `rdg-viewport-dragging ${viewportDragging}`;
var focusSinkClassname = "f1lsfrzw7-0-0-beta-42";
var focusSinkHeaderAndSummaryClassname = "f1cte0lg7-0-0-beta-42";
var summaryCellClassname = "s8wc6fl7-0-0-beta-42";
...
var summaryRow = "skuhp557-0-0-beta-42";
var topSummaryRow = "tf8l5ub7-0-0-beta-42";
var topSummaryRowBorderClassname = "tb9ughf7-0-0-beta-42";
var bottomSummaryRowBorderClassname = "b1yssfnt7-0-0-beta-42";
...
function DataGrid(props, ref) {
  ...
  function handleKeyDown(event) {
    ...
    if (selectedCellIsWithinViewportBounds && (onPaste != null || onCopy != null) && isCtrlKeyHeldDown(event)) {
      ...
      const vKey = 86;
      if (keyCode === cKey) {
        if (((_a = window.getSelection()) == null ? void 0 : _a.isCollapsed) === false)
          return;
        handleCopy();
        return;
      }
...
var groupRow = "g1yxluv37-0-0-beta-42";
...
var textEditorInternalClassname = "t7vyx3i7-0-0-beta-42";
